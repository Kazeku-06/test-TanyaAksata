...
class PostController extends Controller
{
    ...
    // Detail postingan (publik) — cached 1 menit, views_count selalu diincrement
    public function show(Request $request, $id)
    {
        ...
        // Increment views di DB (tidak di-cache agar akurat)
        $post->increment('views_count');

        // Hapus cache detail karena views_count berubah
    ...
    // Search posts — tidak di-cache karena param bisa sangat bervariasi
